...
public class PokemonEventActivity extends AppCompatActivity {

    public static final String url ="https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=357&per_page=100";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pokemon_event);
        initViews();
    ...
    {
        layout = findViewById(R.id.containerInEvent);
        progressDialog = new ProgressDialog(this);

        mToolbar = findViewById(R.id.pokemoneEventsToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.pokemoneEventsPapersRvList);
            ...
            public void onResponse(String response) {
             ...
             progressDialog.dismiss();
                ...
                try {
                    ...
                    Toast.makeText(PokemonEventActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }

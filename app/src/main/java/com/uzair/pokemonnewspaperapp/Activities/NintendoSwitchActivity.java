...
public class NintendoSwitchActivity extends AppCompatActivity {

    public static final String  url ="https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=858&per_page=100";
    ...
    {
        layout  = findViewById(R.id.containerInSwitch);

        mToolbar = findViewById(R.id.nintendoSwitchToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.nintendoSwitchPapersRvList);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(NintendoSwitchActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }

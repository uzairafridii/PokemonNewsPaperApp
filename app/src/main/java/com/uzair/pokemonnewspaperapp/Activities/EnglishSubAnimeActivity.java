...
public class EnglishSubAnimeActivity extends AppCompatActivity {

    public static final String url = "https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=860&per_page=100";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_sub_anime);
    ...
    {
        layout = findViewById(R.id.containerInEnglish);

        mToolbar = findViewById(R.id.englishSubAnimeToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.englishSubAnimePapersRvList);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(EnglishSubAnimeActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }

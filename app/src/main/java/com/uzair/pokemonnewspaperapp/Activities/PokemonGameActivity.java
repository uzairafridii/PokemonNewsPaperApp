...
public class PokemonGameActivity extends AppCompatActivity {

    public static final String url = "https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=3&per_page=100";
    ...
    {
        layout = findViewById(R.id.containerGame);

        progressDialog  = new ProgressDialog(this);

        mToolbar = findViewById(R.id.pokemonGameToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.pokemonGamePapersRvList);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(PokemonGameActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }

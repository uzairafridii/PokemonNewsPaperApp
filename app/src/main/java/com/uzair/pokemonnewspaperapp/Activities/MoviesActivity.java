...
public class MoviesActivity extends AppCompatActivity {
    ...
    public static final String url ="https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=859&per_page=100";
    ...
    {
        layout = findViewById(R.id.containerInMovies);

        mToolbar = findViewById(R.id.moviesToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.moviesPapersRvList);

...
public class PokemonGoActivity extends AppCompatActivity {

    public static final String url ="https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=4&per_page=100";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pokemon_go);
    ...
    private void initViews() {
        ...
        layout = findViewById(R.id.containerGo);
        progressDialog = new ProgressDialog(this);

        mToolbar = findViewById(R.id.pokemonGoToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.pokemonGoPapersRvList);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(PokemonGoActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }

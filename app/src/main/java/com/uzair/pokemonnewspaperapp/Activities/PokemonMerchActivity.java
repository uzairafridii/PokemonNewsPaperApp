...
public class PokemonMerchActivity extends AppCompatActivity {


    public static final String url = "https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=5&per_page=100";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pokemon_merch);
    ...
    {
        layout = findViewById(R.id.containerMerch);

        progressDialog  = new ProgressDialog(this);
        gson = new Gson();

        mToolbar = findViewById(R.id.pokemonMerchToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.pokeMonMerchRvList);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(PokemonMerchActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }

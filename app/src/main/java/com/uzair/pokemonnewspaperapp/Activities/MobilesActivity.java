...
public class MobilesActivity extends AppCompatActivity {
    ...
    public static final String url ="https://www.pokemonnewspaper.com.au/wp-json/wp/v2/posts?categories=857&per_page=100";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            snackBar("Soryy no internet connection");
        }
    }

    private void initViews()
    {
        layout = findViewById(R.id.containerInMobiles);

        mToolbar = findViewById(R.id.mobilesToolbar);
        ...
        // recycler view
        newsPaperRvList = findViewById(R.id.mobilesPapersRvList);
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(MobilesActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }
